      ...
      <div className="container-max">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          {featuredServices.map((service, index) => (
            <div key={index} className="bg-gradient-to-br from-blue-600 to-purple-700 text-white p-8 rounded-xl hover:shadow-xl transition-shadow">
              ...
              <ul className="space-y-2">
                {service.features.map((feature, featureIndex) => (
                  <li key={featureIndex} className="flex items-center text-blue-50">
