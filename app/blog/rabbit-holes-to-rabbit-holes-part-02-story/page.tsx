  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-16">
      ...
      <header className="text-center mb-20">
        ...
        <SeriesProgress currentPart={2} className="mt-4" />
      </header>
      ...
      <StorySection>
        <div className="text-center bg-gray-900 rounded-2xl p-12 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href={'/blog/rabbit-holes-to-rabbit-holes-part-01-story'}
              className="bg-orange-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-orange-700 transition-colors">
              Read Part 1: My Developer Origin Story
            </Link>
            ...
            <Link
              href={'/blog/rabbit-holes-to-rabbit-holes-part-03-story'}
