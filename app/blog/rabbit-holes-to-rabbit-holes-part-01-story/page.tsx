      ...
      <StorySection>
        <div className="text-center bg-gray-900 rounded-2xl p-12 text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href={'/blog/rabbit-holes-to-rabbit-holes-story'}
              className="bg-green-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
            ...
            <Link
              href={'/blog/rabbit-holes-to-rabbit-holes-part-02-story'}
