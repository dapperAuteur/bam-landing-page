  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12 space-y-12">
      ...
      <header className="text-center space-y-6">
        ...
        {/* <PartNavigation currentPart={4} className="mt-12" />
        <SeriesBreadcrumb currentPart={4} className="mb-8" /> */}
        {/* <FloatingSeriesNav currentPart={4} /> */}
    ...
    // ... other states
      ...
      <section className="space-y-6">
        ...
        <div className="flex justify-center space-x-4">
          <Link
            href={'/blog/rabbit-holes-to-rabbit-holes-part-03-professional'}
          ...
          <Link
            href={'/blog/rabbit-holes-to-rabbit-holes-part-05-professional'}
