...
- [Building Effective Agents](https://www.anthropic.com/research/building-effective-agents) by Anthropic: the clearest essay on when to use workflows vs. agents.
- [Tool use overview](https://platform.claude.com/docs/en/agents-and-tools/tool-use/overview) in the Anthropic docs: how tool schemas and the call/result loop actually work.
...
- [Neural networks video series](https://www.3blue1brown.com/topics/neural-networks) by 3Blue1Brown: the best visual explanation of what's inside the model itself.
