...
- **A clean mis-route (95.2%):** "Is foam rolling after workouts actually worth the time?" never reached the recovery specialist — the routing prompt's recovery description didn't claim post-workout modalities.
...
And then there's the headline number: citation discipline moved nine and a half points — real, but nowhere near the 100% the interlock was supposed to deliver. This is the part worth reading.
